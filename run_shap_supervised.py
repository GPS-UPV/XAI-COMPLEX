...
def main():
    ...
    feat_mask = [c for c in df_feats.columns if "betweenness_c_" not in c and not (("deg" in c or "clustering" in c) and ("_c_" not in c and "_d_" not in c)) and "graph_density" != c]
    ...
    feature_map = {
        ...
        "clustering_d_min": r"$\mathcal{C}_d^{min}$",
        "clustering_d_max": r"$\mathcal{C}_d^{max}$",
        "clustering_d_mean": r"$\mathcal{C}_d^{mean}$",
        "clustering_d_median": r"$\mathcal{C}_d^{median}$",
        "clustering_d_std": r"$\mathcal{C}_d^{std}$",
        "clustering_d_range": r"$\mathcal{C}_d^{range}$",
        "clustering_d_q1": r"$\mathcal{C}_d^{q1}$",
        "clustering_d_q3": r"$\mathcal{C}_d^{q3}$",
        "clustering_d_gini": r"$\mathcal{C}_d^{gini}$",
        ...
        "betweenness_c_min": r"$\mathcal{B}_c^{min}$",
        "betweenness_c_max": r"$\mathcal{B}_c^{max}$",
        "betweenness_c_mean": r"$\mathcal{B}_c^{mean}$",
        "betweenness_c_median": r"$\mathcal{B}_c^{median}$",
        "betweenness_c_std": r"$\mathcal{B}_c^{std}$",
        "betweenness_c_range": r"$\mathcal{B}_c^{range}$",
        "betweenness_c_q1": r"$\mathcal{B}_c^{q1}$",
        "betweenness_c_q3": r"$\mathcal{B}_c^{q3}$",
        "betweenness_c_gini": r"$\mathcal{B}_c^{gini}$",
        "graph_density": r"$dens(G)$",
        "deg_min": r"$\deg^{min}$",
        "deg_max": r"$\deg^{max}$",
        "deg_mean": r"$\deg^{mean}$",
        "deg_median": r"$\deg^{median}$",
        "deg_std": r"$\deg^{std}$",
        "deg_range": r"$\deg^{range}$",
        "deg_q1": r"$\deg^{q1}$",
        "deg_q3": r"$\deg^{q3}$",
        "deg_gini": r"$\deg^{gini}$",
        "clustering_min": r"$\mathcal{C}^{min}$",
        "clustering_max": r"$\mathcal{C}^{max}$",
        "clustering_mean": r"$\mathcal{C}^{mean}$",
        "clustering_median": r"$\mathcal{C}^{median}$",
        "clustering_std": r"$\mathcal{C}^{std}$",
        "clustering_range": r"$\mathcal{C}^{range}$",
        "clustering_q1": r"$\mathcal{C}^{q1}$",
        "clustering_q3": r"$\mathcal{C}^{q3}$",
        "clustering_gini": r"$\mathcal{C}^{gini}$",
        "betweenness_min": r"$\mathcal{B}^{min}$",
        "betweenness_max": r"$\mathcal{B}^{max}$",
        "betweenness_mean": r"$\mathcal{B}^{mean}$",
        "betweenness_median": r"$\mathcal{B}^{median}$",
        "betweenness_std": r"$\mathcal{B}^{std}$",
        "betweenness_range": r"$\mathcal{B}^{range}$",
        "betweenness_q1": r"$\mathcal{B}^{q1}$",
        "betweenness_q3": r"$\mathcal{B}^{q3}$",
        "betweenness_gini": r"$\mathcal{B}^{gini}$",
        "makespan_min": r"$C^{min}$",
        "makespan_range": r"$C^{range}$",
